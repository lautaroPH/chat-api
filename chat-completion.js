...
const QA_PROMPT = PromptTemplate.fromTemplate(
  ...
  You should only use as main links those that have the domain https://www.chenkster.xyz/country/[countryName]/[cityName]/[categoryName]/[placeName] explicitly listed in this context. If the place contain an -, for example Walking Tour - Citywalkers in the URL put it like this walking-tour%20-%20citywalkers. If necessary, or to provide additional information aside from the first, most important link, you can use a secondary link from another webpage that discusses the topic.
